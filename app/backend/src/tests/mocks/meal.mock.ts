...
export const recipeByCategoryGoat = [
  {
    "idMeal": 176,
...
export const inProgressDefault = {
  dataValues: {
    id: 2,
    userId: '3',
    mealId: '3',
    markedIngredients: startMealRecipeInProgress()
  }
};
