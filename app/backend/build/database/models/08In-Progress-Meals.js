...
_00UserModel_1.default.belongsTo(InProgressMealsModel, { as: 'userId', foreignKey: 'id' });
_04Meals_Recipes_1.default.belongsTo(InProgressMealsModel, { as: 'mealId', foreignKey: 'idMeal' });
