...
mealsRouter.get('/ingredient', auth_middlware_1.default.auth, (req, res) => mealsController.getByIngredient(req, res));
...
mealsRouter.get('/favorites/name', (req, res) => mealsController.getFavoriteRecipes(req, res));
