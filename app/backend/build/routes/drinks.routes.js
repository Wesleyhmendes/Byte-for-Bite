...
drinksRouter.get('/favorites/search', (req, res) => drinkController.getFavoriteRecipes(req, res));
drinksRouter.post('/favorites/:id', auth_middlware_1.default.auth, (req, res) => drinkController.favoriteDrinkRecipe(req, res));
drinksRouter.post('/donerecipes/:id', (req, res) => drinkController.addDoneDrink(req, res));
drinksRouter.get('/donerecipes/search', (req, res) => drinkController.getDoneRecipes(req, res));
