...
export default function Recipes() {
  const { byCategory, path, allRecipes, selectedCategory } = useContext(Context) 
  ...
  return (
    <main>
      <Category />
      {/* {!byCategory.isLoading && selectedCategory !== '' ? (
        <RecipesMiniCard recipeData={ byCategory } path={ path }/>
      ) : null }

      {!allRecipes.isLoading && selectedCategory === '' ? (
        <RecipesMiniCard recipeData={ allRecipes } path={ path }/>
      ): null } */}
      { location === '/meals' ? (
